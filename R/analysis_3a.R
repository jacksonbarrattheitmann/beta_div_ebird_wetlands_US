...
wet_eco_summer <- readRDS("Intermediate_data/all_wet_check_dominants_removed_summer.RDS")

wet_eco_fall <- readRDS("Intermediate_data/all_wet_check_dominants_removed_fall.RDS")

wet_eco_spring <- readRDS("Intermediate_data/all_wet_check_dominants_removed_spring.RDS")

wet_eco_winter <- readRDS("Intermediate_data/all_wet_check_dominants_removed_winter.RDS")
...
#saveRDS(beta_results_eco, "Intermediate_data/beta_results_eco_dom_removed.RDS")

beta_results <- readRDS("Intermediate_data/beta_results_eco_dom_removed.RDS")
